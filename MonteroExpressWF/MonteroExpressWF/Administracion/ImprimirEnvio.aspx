    ...
    <div class="container body-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                <p class="text-justify">
                    El que suscribe <asp:Label runat="server" ID="lblSuscribe" style="text-decoration:underline"></asp:Label> provisto de D.N.I <asp:Label runat="server" style="text-decoration:underline" ID="lblDni"></asp:Label> en calidad de EXPORTADOR por el presente documento, hago constar y participo 
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <strong>Contenidos del envio:</strong> <asp:Label runat="server" ID="lblContenidoEnvio"></asp:Label>
                    </div>
                </div>
